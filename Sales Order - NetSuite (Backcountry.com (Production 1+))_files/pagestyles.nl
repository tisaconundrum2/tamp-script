...
.subtabbarinnerul	{ font-size: 0px; width: 2px; height: 2px; background: url(/images/core/common/corner_r3_t_gray_w.png) #DCDCDC 1px 0px; }
.subtabbarinnerur	{ font-size: 0px; width: 2px; height: 2px; background: url(/images/core/common/corner_r3_t_gray_w.png) #DCDCDC 1px 0px; }
.subtabbarinnerll	{ font-size: 0px; width: 2px; height: 2px; background: url(/images/core/common/corner_r3_t_gray_w.png) #DCDCDC 1px 2px; }
.subtabbarinnerlr	{ font-size: 0px; width: 2px; height: 2px; background: url(/images/core/common/corner_r3_t_gray_w.png) #DCDCDC 1px 2px; }
...
.ri_personalize { background-position: -50px -7px; margin-right: 0px; width: 12px; height: 16px; vertical-align: baseline; }
...
a.newbar .ri_quote,
.ri_estimate { background-position: -50px -425px; }
...
a.newbar .ri_invoice { background-position: -50px -450px; }
...
a.newbar .ri_project,
a.newbar .ri_job { background-position: -50px -650px; }
...
a.newbar .ri_customicon			{ background-position: -50px -25px; }
...
a.newbar .ri_partner			{ background-position: -50px -675px; }
a.newbar .ri_topic			{ background-position: -50px -700px; }
a.newbar .ri_solution			{ background-position: -50px -725px; }
a.newbar .ri_employeesched		{ background-position: -50px -750px; }
a.newbar .ri_partnersched		{ background-position: -50px -775px; }
a.newbar .ri_informationitem		{ background-position: -50px -800px; }
a.newbar .ri_payrolladjustment		{ background-position: -50px -825px; }
a.newbar .ri_vendorcredit		{ background-position: -50px -850px; }
a.newbar .ri_shippingitem		{ background-position: -50px -875px; }
a.newbar .ri_workorder			{ background-position: -50px -900px; }
a.newbar .ri_journal			{ background-position: -50px -925px; }
a.newbar .ri_creditcard			{ background-position: -50px -950px; }
a.newbar .ri_check			{ background-position: -50px -975px; }
a.newbar .ri_payment			{ background-position: -50px -1000px; }
a.newbar .ri_tax			{ background-position: -50px -1025px; }
a.newbar .ri_customerpayment		{ background-position: -50px -1050px; }
a.newbar .ri_inventory			{ background-position: -50px -1075px; }
a.newbar .ri_build			{ background-position: -50px -1100px; }
a.newbar .ri_vendor			{ background-position: -50px -1125px; }
a.newbar .ri_competitor			{ background-position: -50px -1150px; }
a.newbar .ri_employeecommission		{ background-position: -50px -1175px; }
a.newbar .ri_itemfulfillment		{ background-position: -50px -1200px; }
a.newbar .ri_group			{ background-position: -50px -1225px; }
a.newbar .ri_transfer			{ background-position: -50px -1250px; }
a.newbar .ri_deposit			{ background-position: -50px -1275px; }
a.newbar .ri_customrecord		{ background-position: -50px -1300px; }
a.newbar .ri_expensereport		{ background-position: -50px -1325px; }
a.newbar .ri_purchaseorder		{ background-position: -50px -1350px; }
a.newbar .ri_customerrefund		{ background-position: -50px -1375px; }
a.newbar .ri_cashrefund			{ background-position: -50px -1400px; }
a.newbar .ri_returnauthorization	{ background-position: -50px -1425px; }
a.newbar .ri_generic			{ background-position: -50px -1450px; }
a.newbar .ri_resourceallocation		{ background-position: -50px -1475px; } 
...
a.newbar .ri_bill			{ background-position: -50px -1350px; }
...
.pgm_menu,
.pgm_action_menu { font-family: Arial,Helvetica,sans-serif; font-size: 8pt; position: relative; top: 5px; }

.pgm_tri { background-image: url(/images/chiles/navmenu/triangle_sm_down.png); height: 5px; width: 5px; position: relative; }

.ac_container,
.ac_container_bot { background-color: #444444; position: relative; z-index: 1000; display: inline-block; }
...
.ac_table { border: 1px solid #B0B0B0; background: #444444 url(/images/chiles/navmenu/pgmenu_main_bg.png) repeat scroll; white-space: nowrap; min-width: 100px; }
...
.pt_title { font-size: 17px;	font-weight: bold;	color: #121212;	position: relative;	top: 2px; left: 10px; float: left; }
.pt_bg { background-color: #121212; }
.pt_statusblock {	text-align: center; position: absolute; right: 0px; background-color: #DADADA; height: 26px; min-width: 180px; padding-right: 15px; }
...
.portletBgColor { background-color: #444444; }
...
.portletTitleBg { background: #444444 url(/images/icons/dashboard/chiles/dashboard.png) no-repeat right top; height: 20px; }
.portletTitle { position: relative; left: -3px; top: 2px; }
.portletTitleText { font-weight: bold; white-space: nowrap; font-size: 11px; color: #FFFFFF; }
...
.portletLeftSide { background: #444444 url(/images/icons/dashboard/chiles/dashboard.png) no-repeat left -20px; padding-left: 3px; } 
.portletRightSide { background: #444444 url(/images/icons/dashboard/chiles/dashboard.png) no-repeat right -20px; padding-right: 3px; } 
.portletFooter { background: #444444 url(/images/icons/dashboard/chiles/dashboard.png) no-repeat right -1597px; height: 3px; } 
.portletBottomCorner { background: #444444 url(/images/icons/dashboard/chiles/dashboard.png) no-repeat left -1597px; float: left; padding: 3px 0px 0 10px; zoom: 1; }
.portletIcons { }
...
.portletIconMenu { background-position: -60px 0; }
.portletIconMenuSel { background-position: -80px 0; }
.portletIconRefresh { background-position: -60px -20px; }
.portletIconRefresh:hover { background-position: -80px -20px; }
.portletIconRefresh:active { background-position: -100px -20px; }
.portletIconRefreshing { display: inline-block; height: 15px; width: 16px; margin: 0 2px; background: url(/images/chiles/dashboard/anim3-light.gif) no-repeat; text-decoration: none; zoom: 1; }
.portletIconMinimize { background-position: -60px -40px; }
.portletIconMinimize:hover { background-position: -80px -40px; }
.portletIconMinimize:active { background-position: -100px -40px; }
.portletIconMaximize { background-position: -60px -60px; }
.portletIconMaximize:hover { background-position: -80px -60px; }
.portletIconMaximize:active { background-position: -100px -60px; }
.portletIconHide { background-position: -60px -80px; }
.portletIconHide:hover { background-position: -80px -80px; }
.portletIconHide:active { background-position: -100px -80px; }
...
.plchiles .bgofftab { border-top: 1px solid #AFB5BF; border-bottom: 1px solid #333333; background: url(/images/tabs/png/chiles/menu_sprite.png) repeat scroll -50px 0px; padding: 0 7px; background-color: #444444; }
...
.bgtabrborder_s { border-bottom: 1px solid #333333; border-top: 1px solid #AFB5BF; background-color: #121212; }
...
.menuTableDiv { border: 1px solid #B5B5B5; background-color: #E3E3E3; padding: 0 1px; }
...
.portlet		{ background-color: #444444; }
.portletlabel		{ color: #FFFFFF; background-color: #444444; }
.portletlabelDragDrop	{ color: #FFFFFF; background-color: #444444; }
.portletDragDropIcon	{ cursor: move; }
.quickaddDragDropIcon	{ cursor: move; }
.portletDragDropBar	{ color: #444444; }
...
.bgbutton		{ background-color: #3B89D8; }
.bgmd			{ background-color: #DADADA; }
.bgdk			{ background-color: #808080; }
.bgontab		{ background-color: #121212; text-align: center; vertical-align: middle; }
.bgofftab		{ background-color: #444444; text-align: center; vertical-align: middle; }
.bghovertab		{ background-color: #121212; text-align: center; vertical-align: middle; }

/* list header */
.listheadertd,
.listheadertdleft	{
	vertical-align: top; height: 100%; border-style: solid; border-color: #B4B4B4;
	background: #444444 url(/images/core/list/header_bg_b.png) repeat-x left bottom;
	box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box;
}

/* form tab bar */
.bgtabbar		{ background-color: #7A7A7A; }
.bdtabblock		{ border-style: solid; border-color: #7A7A7A; background-color: #F7F7F7; }
.tabblockcorner		{ background-color: #7A7A7A; }
.tabcontent		{ background-color: #F7F7F7; padding: 5px 0; }
.nltabcontent		{ background-color: #F7F7F7; padding: 5px 0; }

.formtabon		{ padding: 3px 8px 3px 8px; background: #121212 url(/images/forms/tab/tab_on.png) repeat-x; }
.formtaboff		{ padding: 3px 8px 3px 8px; background: #444444 url(/images/forms/tab/tab_off.png) repeat-x; }
...
.formtabseplon		{ position: relative; width: 2px; vertical-align: top; background: #121212 url(/images/forms/tab/tab_on_l.png) repeat-y; }
.formtabseploff		{ position: relative; width: 2px; vertical-align: top; background: #444444 url(/images/forms/tab/tab_off_l.png) repeat-y; }
.formtabsepron		{ position: relative; width: 5px; vertical-align: top; background: #121212 url(/images/forms/tab/tab_on_r.png) repeat-y; }
.formtabseproff		{ position: relative; width: 5px; vertical-align: top; background: #444444 url(/images/forms/tab/tab_off_r.png) repeat-y; }

/* form tab bar corners */
.formtabsepclon		{ position: relative; top: 0px; width: 5px; height: 5px; font-size: 0px; background: #121212 url(/images/forms/tab/tab_on_corner_l.png) no-repeat; }
.formtabsepcloff	{ position: relative; top: 0px; width: 5px; height: 5px; font-size: 0px; background: #444444 url(/images/forms/tab/tab_off_corner_l.png) no-repeat; }
.formtabsepcron		{ position: relative; top: 0px; width: 5px; height: 5px; font-size: 0px; background: #121212 url(/images/forms/tab/tab_on_corner_r.png) no-repeat; }
.formtabsepcroff	{ position: relative; top: 0px; width: 5px; height: 5px; font-size: 0px; background: #444444 url(/images/forms/tab/tab_off_corner_r.png) no-repeat; }

/* form tab bar corners */
.unrollformtabbar	{ font-size: 8pt; background: #121212 url(/images/forms/tab/unrolltab_bg.png) repeat-x; }
...
.unrollformtabheaderesep	{ height: 3px; font-size: 0px; background: #121212 url(/images/forms/border/unrollsubtab_header_sep.png) repeat-x; }
.unrollformtablexpand		{ width: 4px; font-size: 0px; background: #121212 url(/images/forms/border/unrolltab_l_expand.png) repeat-y; }
.unrollformtabrexpand		{ width: 4px; font-size: 0px; background: #121212 url(/images/forms/border/unrolltab_r_expand.png) repeat-y; }
.unrollformtabtexpand		{ height: 5px; font-size: 0px; background: #121212 url(/images/forms/border/unrolltab_t_expand.png) repeat-x; }
.unrollformtabbexpand		{ height: 5px; font-size: 0px; background: #121212 url(/images/forms/border/unrolltab_b_expand.png) repeat-x; }
.unrollformtabheaderexpand	{ padding: 5px; background: #121212 url(/images/forms/border/unrolltab_header_expand.png) repeat-x; }

/* corners for unrolled form tab expanded */
.unrollformtabulexpand		{ position: absolute; background: #121212 url(/images/forms/border/unrolltab_square_corner_expand.png) 0 0 no-repeat; }
.unrollformtabulfirstexpand	{ position: absolute; background: #121212 url(/images/forms/border/unrolltab_rounded_corner_expand.png) 0 0 no-repeat; }
.unrollformtaburexpand		{ position: absolute; right: 0px; background: #121212 url(/images/forms/border/unrolltab_square_corner_expand.png) -8px 0px no-repeat; }
.unrollformtaburfirstexpand	{ position: absolute; right: 0px; background: #121212 url(/images/forms/border/unrolltab_rounded_corner_expand.png) -8px 0px no-repeat; }
.unrollformtabllexpand		{ position: absolute; top: -3px; background: #121212 url(/images/forms/border/unrolltab_square_corner_expand.png) 0px -8px no-repeat; }
.unrollformtablllastexpand	{ position: absolute; top: -3px; background: #121212 url(/images/forms/border/unrolltab_rounded_corner_expand.png) 0px -8px no-repeat; }
.unrollformtablrexpand		{ position: absolute; right: 0px; top: -3px; background: #121212 url(/images/forms/border/unrolltab_square_corner_expand.png) -8px -8px no-repeat; }
.unrollformtablrlastexpand	{ position: absolute; right: 0px; top: -3px; background: #121212 url(/images/forms/border/unrolltab_rounded_corner_expand.png) -8px -8px no-repeat; }

/* unrolled form tab collapsed */
.unrollformtabheadercollapse	{ padding: 5px; border-bottom: 1px solid #cccccc; background: #121212 url(/images/forms/border/unrolltab_header_collapse.png) repeat-x; }

/* unrolled form tab collapsed */
.unrollformtablcollapse		{ width: 4px; font-size: 0px; background: #121212 url(/images/forms/tab/unrolltab_bg.png); }
.unrollformtabrcollapse		{ width: 4px; font-size: 0px; background: #121212 url(/images/forms/tab/unrolltab_bg.png); }
.unrollformtabtcollapse		{ height: 4px; font-size: 0px; background: #121212 url(/images/forms/tab/unrolltab_bg.png); }
.unrollformtabbcollapse		{ height: 3px; font-size: 0px; background: #121212 url(/images/forms/tab/unrolltab_bg.png); }
...
.unrollformtaburfirstcollapse		{ position: absolute; right: 0px; background: #121212 url(/images/forms/border/unrolltab_rounded_corner_collapse.png) -8px 0px no-repeat; }
.unrollformtabllcollapse		{ position: absolute; }
.unrollformtablllastcollapse		{ position: absolute; top: -5px; background: #121212 url(/images/forms/border/unrolltab_rounded_corner_collapse.png) 0px -8px no-repeat; }
.unrollformtablrcollapse		{ position: absolute; right: 0px; }
.unrollformtablrlastcollapse		{ position: absolute; top: -5px; right: 0px; background: #121212 url(/images/forms/border/unrolltab_rounded_corner_collapse.png) -8px -8px no-repeat; }

/*form subtab bar */
.bgsubtabbar			{ background-color: #DCDCDC; }
.subtabblock			{ background-color: #DCDCDC; }
.bdsubtabblock			{ border-style: solid; border-color: #DCDCDC; }
.subtabcontent			{ background-color: #FFFFFF; }
.nlsubtabcontent		{ background-color: #FFFFFF; }
.subtabcornerul			{ width: 4px; height: 4px; font-size: 0px; background: #DCDCDC url(/images/core/common/corner_r4_t_w.png) 0px 0px; }
.subtabcornerur			{ width: 4px; height: 4px; font-size: 0px; background: #DCDCDC url(/images/core/common/corner_r4_t_w.png) -4px 0px; }
.subtabcornerll			{ width: 4px; height: 4px; font-size: 0px; background: #DCDCDC url(/images/core/common/corner_r4_t_w.png) 0px 4px; }
.subtabcornerlr			{ width: 4px; height: 4px; font-size: 0px; background: #DCDCDC url(/images/core/common/corner_r4_t_w.png) 4px 4px; }

.formsubtab			{ color: #666666; padding: 5px; background: #121212 url(/images/forms/tab/subtab_off.png) repeat-x; }

.formsubtabon			{ padding: 2px 5px 2px 5px; background: #121212 url(/images/forms/tab/subtab_on.png) repeat-x; }
.formsubtaboff			{ padding: 2px 5px 2px 5px; border-bottom: 1px solid #808080; background: #444444 url(/images/forms/tab/subtab_off.png) repeat-x; }
...
.formsubtabcorner		{ background-color: #DCDCDC; }

/* unrolled form subtab expanded */
.unrollformsubtabheaderesep		{ height: 3px; font-size: 0px; background: #121212 url(/images/forms/border/unrollsubtab_header_sep.png) repeat-x; }
.unrollformsubtablexpand		{ width: 3px; font-size: 0px; background: #121212 url(/images/forms/border/unrollsubtab_l_expand.png) repeat-y; }
.unrollformsubtabrexpand		{ width: 3px; font-size: 0px; background: #121212 url(/images/forms/border/unrollsubtab_r_expand.png) repeat-y; }
.unrollformsubtabtexpand		{ height: 4px; font-size: 0px; background: #121212 url(/images/forms/border/unrollsubtab_t_expand.png) repeat-x; }
.unrollformsubtabbexpand		{ height: 4px; font-size: 0px; background: #121212 url(/images/forms/border/unrollsubtab_b_expand.png) repeat-x; }
.unrollformsubtabheaderexpand		{ padding: 5px; background: #121212 url(/images/forms/border/unrollsubtab_header_expand.png) repeat-x; }

/* corners for unrolled form subtab expanded */
.unrollformsubtabulexpand		{ position: absolute; background: #121212 url(/images/forms/border/unrollsubtab_square_corner_expand.png) 0 0 no-repeat; }
.unrollformsubtabulfirstexpand		{ position: absolute; background: #121212 url(/images/forms/border/unrollsubtab_rounded_corner_expand.png) 0 0 no-repeat; }
.unrollformsubtaburexpand		{ position: absolute; right: 0px; background: #121212 url(/images/forms/border/unrollsubtab_square_corner_expand.png) -7px 0px no-repeat; }
.unrollformsubtaburfirstexpand		{ position: absolute; right: 0px; background: #121212 url(/images/forms/border/unrollsubtab_rounded_corner_expand.png) -7px 0px no-repeat; }
...
/* unrolled form subtab collapsed */
.unrollformsubtabheadercollapse		{ padding: 5px; border-bottom: 1px solid #cccccc; background: #121212 url(/images/forms/border/unrollsubtab_header_collapse.png) repeat-x; }

/* corners for unrolled form subtab collapsed */
.unrollformsubtabulcollapse		{ position: absolute; }
.unrollformsubtabulfirstcollapse	{ position: absolute; background: #121212 url(/images/forms/border/unrollsubtab_rounded_corner_collapse.png) 0 0 no-repeat; }
.unrollformsubtaburcollapse		{ position: absolute; right: 0px; }
.unrollformsubtaburfirstcollapse	{ position: absolute; right: 0px; background: #121212 url(/images/forms/border/unrollsubtab_rounded_corner_collapse.png) -7px 0px no-repeat; }
.unrollformsubtabllcollapse		{ position: absolute; top: -5px; }
.unrollformsubtablllastcollapse		{ position: absolute; top: -5px; background: #121212 url(/images/forms/border/unrollsubtab_rounded_corner_collapse.png) 0px -7px no-repeat; }
.unrollformsubtablrcollapse		{ position: absolute; top: -5px; right: 0px; }
.unrollformsubtablrlastcollapse		{ position: absolute; top: -5px; right: 0px; background: #121212 url(/images/forms/border/unrollsubtab_rounded_corner_collapse.png) -7px -7px no-repeat; }

.bgontabsub		{ background-color: #121212; border-top: 1px solid #808083; border-bottom: 1px solid #808083; }
...
.bgontabsubmid		{ background-color: #121212; border-top: 1px solid #808083; border-bottom: 1px solid #808083; }
...
.bgon			{ background-color: #121212; }
.bgoff			{ background-color: #444444; }
.headbar		{ font-size: 8pt; color: #AEAEAE; text-decoration: none; background-color: #121212; }
.headbarsub		{ color: #AEAEAE; }
.headbarsubnolink	{ color: #AEAEAE; }
.crosslinktitle		{ color: #AEAEAE; }
.crosslinktext,
.crosslinktextul,
a.newbar		{ color: #E4EAF4; }
.crumb			{ color: #4D4D4D; text-decoration: none; }
.crumbover		{ color: #4D4D4D; }
.ontab			{ color: #FFFFFF; }
.offtab			{ color: #000000; }
...
.texttable		{ font-size: 8pt; color: #000000; background-color: #FFFFFF; padding: 2px 5px 2px 5px ; border-style: solid; border-width: 1px 1px 1px 1px; border-color: white #FFFFFF #FFFFFF #FFFFFF; vertical-align: top; }
.texttablebold		{ font-size: 8pt; color: #000000; background-color: #FFFFFF; padding: 2px 5px 2px 5px; font-weight: bold; border-style: solid; border-width: 1px 0 0 0; border-color: white; vertical-align: top; }
.texttablectr		{ font-size: 8pt; color: #000000; background-color: #FFFFFF; text-align: center; padding: 2px 5px 2px 5px; border-style: solid; border-width: 1px 0 0 0; border-color: white; vertical-align: top; }
.texttablert		{ font-size: 8pt; color: #000000; background-color: #FFFFFF; text-align: right; padding: 2px 5px 2px 5px; border-style: solid; border-width: 1px 0 0 0; border-color: white; vertical-align: top; }
...
.listtexthl,
.xxlisttexthl		{ font-size: 8pt; color: #000000; padding: 2px 5px 2px 5px; background-color: #FFFFFF; border-style: solid; border-width: 1px 1px 1px 1px; border-color: white #FFFFFF #FFFFFF #FFFFFF; vertical-align: top; }
.listtexthlbold,
.xxlisttexthlbold	{ font-size: 8pt; color: #000000; padding: 2px 5px 2px 5px; background-color: #FFFFFF; border-style: solid; border-width: 1px 1px 1px 1px; border-color: white #FFFFFF #FFFFFF #FFFFFF; vertical-align: top; font-weight: bold; }
.listtexthlctr,
.xxlisttexthlctr	{ font-size: 8pt; color: #000000; padding: 2px 5px 2px 5px; background-color: #FFFFFF; border-style: solid; border-width: 1px 1px 1px 1px; border-color: white #FFFFFF #FFFFFF #FFFFFF; vertical-align: top; text-align: center; }
.listtexthlrt,
.xxlisttexthlrt		{ font-size: 8pt; color: #000000; padding: 2px 5px 2px 5px; background-color: #FFFFFF; border-style: solid; border-width: 1px 1px 1px 1px; border-color: white #FFFFFF #FFFFFF #FFFFFF; vertical-align: top; text-align: right; }
...
.listtexthl2,
.xxlisttexthl2		{ font-size: 8pt; color: #000000; padding: 2px 5px 2px 5px; background-color: #FFFFFF; border-width: 0; vertical-align: top; }
.listtexthlbold2,
.xxlisttexthlbold2	{ font-size: 8pt; color: #000000; padding: 2px 5px 2px 5px; background-color: #FFFFFF; border-width: 0; vertical-align: top; font-weight: bold; }
.listtexthlctr2,
.xxlisttexthlctr2	{ font-size: 8pt; color: #000000; padding: 2px 5px 2px 5px; background-color: #FFFFFF; border-width: 0; vertical-align: top; text-align: center; }
.listtexthlrt2,
.xxlisttexthlrt2	{ font-size: 8pt; color: #000000; padding: 2px 5px 2px 5px; background-color: #FFFFFF; border-width: 0; vertical-align: top; text-align: right; }
...
.listtextnoneditleft	{ border-width: 2px 0 0 2px; border-color: #121212; }
.listtextnonedit	{ border-width: 2px 0 0 0; border-color: #121212; }
.listtextnoneditright	{ border-width: 2px 2px 0 0; border-color: #121212; }
...
.machineButtonRow	{ background-color: #121212; font-size: 8pt; padding: 2px 2px 2px 2px; vertical-align: top; }

/*non-inline edit machine */
.listfocusedrowleft		{ border-width: 2px 0 2px 2px; border-color: #121212; }
.listfocusedrow			{ border-width: 2px 0 2px 0; border-color: #121212; }
.listfocusedrowright		{ border-width: 2px 2px 2px 0; border-color: #121212; }
.listfocusedrowleftright	{ border-width: 2px 2px 2px 2px; border-color: #121212; }
...
.listinlinefocusedrowleft	{ border-width: 2px 0 2px 2px; border-color: #121212; }
.listinlinefocusedrow		{ border-width: 2px 0 2px 0; border-color: #121212; }
.listinlinefocusedrowright	{ border-width: 2px 2px 2px 0; border-color: #121212; }
.listinlinefocusedrowleftright	{ border-width: 2px 2px 2px 2px; border-color: #121212; }
...
.batchxxgridlisttextbot		{ background-color: #DADADA; font-size: 8pt ; padding: 2px 5px 2px 5px; color: #000000; border-style: solid dotted dotted dotted; border-width: 1px 1px 1px 1px; border-color: #DADADA black black black; vertical-align: top; }
.batchxxgridlisttextmid		{ background-color: #DADADA; font-size: 8pt ; padding: 2px 5px 2px 5px; color: #000000; border-style: solid dotted solid dotted; border-width: 1px 1px 1px 1px; border-color: #DADADA black #DADADA black; vertical-align: top; }
.batchxxgridlisttexttop		{ background-color: #DADADA; font-size: 8pt ; padding: 2px 5px 2px 5px; color: #000000; border-style: dotted dotted solid dotted; border-width: 1px 1px 1px 1px; border-color: black black #DADADA black; vertical-align: top; }
.batchxxgridlisttextuni		{ background-color: #DADADA; font-size: 8pt ; padding: 2px 5px 2px 5px; color: #000000; border-style: dotted; border-width: 1px 1px 1px 1px; border-color: black black black black; vertical-align: top; }
...
.seltexttable			{ background-color: #DADADA; font-size: 8pt; padding: 2px 5px 2px 5px; border-style: solid; border-width: 1px 0 0 0; border-color: white; vertical-align: top; }
.seltexttablectr		{ background-color: #DADADA; font-size: 8pt ; text-align: center; padding: 2px 5px 2px 5px; border-style: solid; border-width: 1px 0 0 0; border-color: white; vertical-align: top; }
.seltexttablert			{ background-color: #DADADA; font-size: 8pt ; text-align: right; padding: 2px 5px 2px 5px; border-style: solid; border-width: 1px 0 0 0; border-color: white; vertical-align: top; }

.sellisttext,
.sellisttexthl			{ font-size: 8pt; color: #000000; padding: 2px 5px 2px 5px ; background-color: #DADADA; border-style: solid; border-width: 1px 1px 1px 1px; border-color: white #DADADA #DADADA #DADADA; vertical-align: top; }
.sellisttextctr,
.sellisttexthlctr		{ font-size: 8pt; color: #000000; text-align: center; padding: 2px 5px 2px 5px; background-color: #DADADA; border-style: solid; border-width: 1px 1px 1px 1px; border-color: white #DADADA #DADADA #DADADA; vertical-align: top; }
.sellisttextrt,
.sellisttexthlrt		{ font-size: 8pt; color: #000000; text-align: right; padding: 2px 5px 2px 5px; background-color: #DADADA; border-style: solid; border-width: 1px 1px 1px 1px; border-color: white #DADADA #DADADA #DADADA; vertical-align: top; }
...
.listcornerul			{ width: 4px; height: 4px; font-size: 0px; background: #DCDCDC url(/images/core/common/corner_r3_t_gray_w.png) 0px 0px; }
.listcornerur			{ width: 4px; height: 4px; font-size: 0px; background: #DCDCDC url(/images/core/common/corner_r3_t_gray_w.png) -3px 0px; }
.listcornerll			{ width: 4px; height: 4px; font-size: 0px; background: #DCDCDC url(/images/core/common/corner_r3_t_gray_w.png) 0px 3px; }
.listcornerlr			{ width: 4px; height: 4px; font-size: 0px; background: #DCDCDC url(/images/core/common/corner_r3_t_gray_w.png) 3px 3px; }
...
.bgltmedtext			{ background-color: #FFFFFF; font-size: 8pt; color: #000000; }
...
.ddmTextOver			{ background-color: #595959; color: #FFFFFF; FONT-SIZE: 8pt; text-decoration: none; vertical-align: middle; font-weight: normal; }
.ddmAnchor: hover		{ color: #FFFFFF; }
.ddmDiv				{ position: absolute; background: #DADADA; border-style: solid; border-width: 1px; border-color: #44546B; padding: 0; cursor: default; }
...
.portlettexthlctr,
.xxportlettexthlctr		{ font-size: 8pt ; color: #000000; border-style: solid; border-width: 1px 1px 1px 1px; padding: 0 0 1px 0; background-color: #FFFFFF; border-color: white white white white; text-align: center; }
.portlettexthlrt,
.xxportlettexthlrt		{ font-size: 8pt ; color: #000000; border-style: solid; border-width: 1px 1px 1px 1px; padding: 0 0 1px 0; background-color: #FFFFFF; border-color: white white white white; text-align: right; }
.portlettexthl,
.xxportlettexthl		{ font-size: 8pt ; color: #000000; border-style: solid; border-width: 1px 1px 1px 1px; padding: 0 0 1px 0; background-color: #FFFFFF; border-color: white white white white; }
...
.quickadddiv			{ border-style: solid; border-color: #121212; border-width: 1px 0 0 0; background-color: #EEEEEE; }
.quickadddivportlet		{ border-style: solid; border-color: white #EEEEEE #EEEEEE white; border-width: 1px; background-color: #EEEEEE; }
.quickaddportletheader		{ border-style: solid; border-color: #444444 #999999 #999999 #444444; border-width: 1px; background-color: #444444; }
...
.regmdtext		{ background-color: #DADADA; font-size: 8pt; color: #000000 ; padding: 2px; border-style: solid; border-width: 1px 0px 0px 0px; border-color: #8491A4 #000000 #000000 #000000; }
.reglttext		{ background-color: #FFFFFF; font-size: 8pt; color: #000000; padding: 2px; }
...
.rptcolheaderdiv	{ visibility: hidden; overflow: hidden; position: relative; background-color: #DADADA; color: #262626;}
...
.rptfooterfilter		{ background-color: #DADADA; width: 100%; border-top: 1px solid #808080; }
...
.rptfindbox		{ text-align: right; vertical-align: bottom; background: #DADADA;}
.rptfindboxrow		{ background-color: #DADADA; vertical-align: middle; }
.rptfindboxrowimage		{ background-color: #DADADA; vertical-align: middle; }
...
.rptrowhighlight {background-color: #DADADA;}
...
.navtitle		{ background-color: #121212; font-weight: bold; font-family: Arial,Helvetica,sans-serif; font-size: 11px; padding: 3px ; border-style: solid; border-width: 1px 0px 1px 1px; border-color: #ffffff #9c9a97 #9c9a97 #ffffff; }
.navend			{ background-color: #121212; font-weight: bold; font-family: Arial,Helvetica,sans-serif; padding: 3px ; border-style: solid; border-style: solid; border-width: 1px 0px 1px 0px; border-color: #ffffff #9c9a97 #9c9a97 #ffffff; }
...
.checkoutprogresstext	{ font-family: Arial,Helvetica,sans-serif; font-size: 8pt ; font-weight: normal; color: #121212; border-style: none; }
...
.extcartborder		{ padding: 2px 5px; border-top: 1px solid #DADADA; font-size: 8pt; }
.extcartbordershaded	{ padding: 2px 5px; border-top: 1px solid #DADADA; font-size: 8pt ; background-color: #FFFFFF; }
.extcarttotal		{ padding: 2px 5px; border-top: 1px solid #DADADA; font-size: 10pt; }
.extcarttotalshaded	{ padding: 2px 5px; border-top: 1px solid #DADADA; font-size: 10pt ; background-color: #FFFFFF; }
...
@media screen {
	...
	.ns-dashboard-content-manager .ns-portlet-loader__icon--circular .ns-portlet-loader__icon--circular__outline {
		stroke: rgba(68,68,68,0.70) !important;
	}
	...
	.ns-dashboard-content-manager .ns-group-selection ul li.ns-active-group {
		background: #DADADA !important;
		border-color: #121212 !important;	/* need to override border color defined in this file */
		color: #121212 !important;
	}
	...
	.ns-portlet-wrapper.ns-highlight {
		box-shadow: 0 0 20px 3px #444444 !important;
	}
	...
	.ns-dashboard-content-manager div.ns-content-manager-item.ns-content-manager-item-active {
		box-shadow: 0 0 8px 0 rgba(18,18,18,0.50);
	}
