...
NLExtremeEditField.prototype.initCsrfToken = function NLExtremeEditField_initCsrfToken()
{
	var currentToken = JSON.parse(localStorage.getItem("sm.status")).ct;
    if(this.csrfToken == null || this.csrfToken != currentToken)
        this.csrfToken = currentToken;
};
...
NLExtremeEditField.prototype.constructFormForPost = function NLExtremeEditField_constructFormForPost()
{
    ...
    createAndAppendHiddenField(form, "_csrf", this.csrfToken)
...
function resetXlistOptionsImage(imageId, bUp)
{
    ...
    if(bUp)
        image.src = '/images/nav/listoptionsup.gif?v=2020.1.0';
    else
        image.src = '/images/nav/listoptionsdown.gif?v=2020.1.0';
}
